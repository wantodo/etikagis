<%@ Page Title="Empresa" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmEmpresa.aspx.vb" Inherits="Backend.frmEmpresa" %>
                        ...
                        <fieldset class="frame">	
							<legend style="color:#B0C4DE;">Dados</legend>
							    <table>
								    ...
								    <tr>
									    <td>Razão social* </td> <td style="margin-left: 40px">
								    ...
								    <tr>
									    <td>CNPJ*</td> <td>
                                        <asp:TextBox ID="txtCNPJ" runat="server" MaxLength="18" Width="202px" onkeypress="MascaraCNPJ(this, event)" onblur="ValidarCNPJ(this, event)"></asp:TextBox>
                                        </td>
								    </tr>
                            ...
                            <fieldset class="frame">	
								<legend style="color:#B0C4DE;">Dados Cobrança</legend>
								    <table id="tabEnderecoCobranca">
									    ...
									    <tr>
										    <td class="style1">UF</td> <td class="style1">
				...
				<tr>
					<td colspan="2">
                        <asp:Panel ID="Panel1"  runat="server" ScrollBars="Horizontal"
                            style="margin-left:10px; margin-top:20px; max-height:224px; max-width:900px;">
