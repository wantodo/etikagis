Public Class frmRepresentante
    ...
    Private Sub gridRepresentante_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gridRepresentante.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            e.Row.Cells(0).Text = "<a href='frmRepresentante.aspx?editar=1&codigo=" & e.Row.Cells(2).Text & "&nome=" & e.Row.Cells(3).Text & "&empresa=" & e.Row.Cells(4).Text & "&codempresa=" & e.Row.Cells(5).Text & "&perfil=" & e.Row.Cells(6).Text & "&codperfil=" & e.Row.Cells(7).Text & "&cargo=" & e.Row.Cells(8).Text & "&area=" & e.Row.Cells(9).Text & "&telefone=" & e.Row.Cells(10).Text & "&usuario=" & e.Row.Cells(11).Text & "&email=" & e.Row.Cells(12).Text & "&status=" & e.Row.Cells(13).Text & "&codstatus=" & e.Row.Cells(14).Text & "'><img src='../imagens/edit.png'></a>"
